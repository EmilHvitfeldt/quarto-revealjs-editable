...
Plain images and videos are inserted directly in a slide without positional attributes. `{.absolute}` images and divs carry `left=`, `top=`, `width=`, and `height=` attributes and are matched back to the source using those values.
