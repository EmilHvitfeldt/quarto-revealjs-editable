...
Not every image needs to be marked with `{.editable}` in advance. Click the **Modify** button in the menu bar to enter modify mode, then click any plain image on the slide to make it editable on the fly.
