...
When an arrow is selected, a style panel appears in the bottom-left corner of the screen with options to customize the arrow's appearance:

- **Color**: Pick any color for the arrow line and head
- **Width**: Choose line thickness from 1-10px
- **Head**: Select arrowhead style (arrow, stealth, diamond, circle, square, bar, or none)

Style changes are applied immediately and saved with the arrow.
...
```markdown
{{< arrow from="100,200" to="400,300" color="#ff0000" width="4" head="stealth" position="absolute" >}}
